    ...
    <View style={styles.container}>
      <View style={styles.navBar}>
        {NAV_ITEMS.map((item) => {
          ...
          const color = isActive ? '#FFFFFF' : '#A0A8C0';
          const IconComponent = item.type === 'material' ? MaterialCommunityIcons : Ionicons;
            ...
            >
              <View style={[styles.navItem, isActive && styles.navItemActive]}>
                ...
                <View style={[styles.iconCircle, isActive && styles.iconCircleActive]}>
                  <IconComponent name={item.icon as any} size={size} color={color} />
                </View>
